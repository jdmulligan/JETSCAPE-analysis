...
class PlotResults(common_base.CommonBase):
    ...
    def plot_hadron_histograms(self):
        ...
        self.plot_raa('CMS', c, pad=6, raa_type='hadron', cent_type='semicentral',
                      ...
                      mc_centralities=['30-40', '40-50'], do_chi2=True)
    ...
    def plot_jet_histograms(self):
        ...
        self.plot_raa('ALICE', c, pad=1, raa_type='jet', cent_type='central',
                      ...
                      data_centralities=['0-10'], mc_centralities=['0-10'], R=0.2, do_chi2=True)
        self.plot_raa('ALICE', c, pad=5, raa_type='jet', cent_type='central',
                      eta_cut=self.jet_eta_cut_04[2],
                      data_centralities=['0-10'], mc_centralities=['0-10'], R=0.4, do_chi2=True)
        ...
        self.plot_raa('ATLAS', c, pad=6, raa_type='jet', cent_type='semicentral',
                      eta_cut=self.jet_eta_cut_04[1],
                      data_centralities=['30-40'], mc_centralities=['30-40'], R=0.4, do_chi2=True)
        ...
        self.plot_raa('CMS', c, pad=7, raa_type='jet', cent_type='semicentral',
                      eta_cut=self.jet_eta_cut_02[0],
                      data_centralities=['30-50'], mc_centralities=['30-40'], R=0.2, do_chi2=True)
        ...
        self.plot_raa('CMS', c, pad=8, raa_type='jet', cent_type='semicentral',
                      eta_cut=self.jet_eta_cut_04[0],
                      data_centralities=['30-50'], mc_centralities=['30-40'], R=0.4, do_chi2=True)
    ...
    def plot_raa(self, experiment, c, pad, raa_type, cent_type,
                 eta_cut, data_centralities, mc_centralities, R=None, do_chi2=False):
        ...
        if len(self.h_RAA_list) > 0:
            self.plot_RAA_overlay(raa_type, c, pad, predictions_to_plot, h_data_list, experiment, eta_cut, R, do_chi2)

        self.plot_list.append(predictions_to_plot)
        self.plot_list.append(h_data_list)

    #-------------------------------------------------------------------------------------------
    def plot_RAA_overlay(self, raa_type, c, pad, predictions, h_data_list, experiment, eta_cut, R, do_chi2):
        ...
        if raa_type == 'hadron':
            ...
            self.setupLegend(leg,0.025*scale_factor)
        elif raa_type == 'jet':
            scale_factor = 1.
            if pad in [1,5]:
                shift = 0.0
        ...
        for i,prediction in enumerate(predictions):
            ...
            if first_data_entry != None and do_chi2 == True:
               chi2 = self.calculate_chi2(first_data_entry, self.h_RAA_list[i])
            ...
            if chi2 == None:
                ...
                leg.AddEntry(self.h_RAA_list[i],'#alpha_{{s}} = {}, #it{{Q}}_{{0}} = {}, {}% (#chi^{{2}}: {})'.format(alpha_s, Q_switch, cent, chi2),'P')
